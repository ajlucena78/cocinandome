...
class ListaCompraAction extends Action
{
    ...
    public function lista_compra()
    {
        ...
        if ((isset($_SESSION['filtros']['nombre_alimento_listaCompra']) and $_SESSION['filtros']['nombre_alimento_listaCompra']) 
                or (isset($_SESSION['filtros']['id_clase_alimento_listaCompra']) and ($_SESSION['filtros']['id_clase_alimento_listaCompra'] 
            ...
            if (isset($_SESSION['filtros']['id_clase_alimento_listaCompra']) and ($_SESSION['filtros']['id_clase_alimento_listaCompra'] 
                    or $_SESSION['filtros']['id_clase_alimento_listaCompra'] === '0')) {
