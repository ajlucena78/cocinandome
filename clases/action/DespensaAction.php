<?php
	class DespensaAction extends Action
	{
		...
		public function despensa()
		{
			...
			if ((isset($_SESSION['filtros']['nombre_alimento_despensa']) 
					and $_SESSION['filtros']['nombre_alimento_despensa']) 
					or (isset($_SESSION['filtros']['id_clase_alimento_despensa']) 
					and ($_SESSION['filtros']['id_clase_alimento_despensa'] 
					or $_SESSION['filtros']['id_clase_alimento_despensa'] === '0')))
			{
				...
				if (isset($_SESSION['filtros']['id_clase_alimento_despensa']) 
						and ($_SESSION['filtros']['id_clase_alimento_despensa'] 
						or $_SESSION['filtros']['id_clase_alimento_despensa'] === '0'))
				{
		...
		public function alimentos()
		{
			...
			$excludes = array();
			foreach ($_SESSION['usuario']->despensa() as $idAlimento => $id)
			{
				$excludes[] = $idAlimento;
			}
		...
		public function quit_alimento()
		{
			...
			//se rehace la lista de platos que puedo cocinar con mi despensa
