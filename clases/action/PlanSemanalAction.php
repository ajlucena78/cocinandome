...
class PlanSemanalAction extends Action
{
    ...
    public function comida()
    {
        ...
        if (! isset($_GET['comida']) or ! $_GET['comida'] or $_GET['comida'] < 1 or $_GET['comida'] > 4) {
            if (isset($_SESSION['comida_plan']) and ($_SESSION['comida_plan'] >= 1 or $_SESSION['comida_plan'] <= 4)) {
    ...
    public function elegir_cantidad_alimento()
    {
        ...
        $this->funcion = 'ver_plan(' . $_GET['dia'] . ', ' . $_GET['comida'] . '); actualiza_info_nutricional_plan(); quitar_popup();';
        return 'success';
    }
    ...
    public function elegir_dia()
    {
        if (! isset($_GET['id_alimento']) and ! isset($_GET['id_receta'])) {
            if (isset($_SESSION['criterios']['dia_plan_mostrado']) and $_SESSION['criterios']['dia_plan_mostrado']) {
    ...
    public function elegir_comida()
    {
        ...
        if (! isset($_GET['id_alimento']) and ! isset($_GET['id_receta'])) {
            if (isset($_SESSION['criterios']['dia_plan_mostrado'])) {
                ...
                if (isset($_SESSION['criterios']['comida_plan_mostrado']) and $_SESSION['criterios']['comida_plan_mostrado']) {
                    $plan = new PlanSemanal();
                    $plan->dia = $_GET['dia'];
    ...
    {
        if ((! isset($_GET['id_categoria']) or ! $_GET['id_categoria']) and (! isset($_GET['nombre_plato']) or ! $_GET['nombre_plato'])) {
            return 'error';
        }
        $plato = new Plato();
