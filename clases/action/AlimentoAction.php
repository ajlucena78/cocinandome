<?php
	class AlimentoAction extends Action
	{
		...
		public function elegir()
		{
			...
			if ((!isset($_GET['id_clase_alimento']) or (!$_GET['id_clase_alimento'] 
					and $_GET['id_clase_alimento'] !== '0')) and (!isset($_GET['nombre_alimento']) 
					or !$_GET['nombre_alimento']))
			{
				return 'error';
			}
			...
			$this->alimentos = $this->alimentoService->find($alimento, ALIMENTOS_POPUP, 'nombre_alimento'
					, $likes, null, false, $inicio);
