...
abstract class Model
{
    ...
    public function __construct($datos = null)
    {
        ...
        foreach ($propiedades as $propiedad) {
            if ($propiedad == 'propiedades' or $propiedad == 'propiedades_clase' or $propiedad == 'pk' or $propiedad == 'fk') {
                continue;
            }
        ...
        // Properties of the daughter class, regardless of the father if there is inheritance
        $clasePadre = get_parent_class($this);
        if ($clasePadre != 'Model') {
            $propiedades = array_keys(get_class_vars($clasePadre));
    ...
    private function get($atributo, $id = null, $limite = null, $inicio = null, $soloId = null, $total = false, $criterios = null)
    {
    ...
    protected function load()
    {
        foreach ($this->fk as $propiedad => $fk) {
            if (strtolower($fk->relation_type()) != OneToOne and strtolower($fk->relation_type()) != ManyToOne) {
                continue;
            }
