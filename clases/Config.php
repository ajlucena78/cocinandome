...
class Config
{
    ...
    {
        // Relative URL to the proyect dir
        ...
        if (isset($_SERVER['HTTP_HOST'])) {
            $this->host_app = 'https://' . $_SERVER['HTTP_HOST'];
        }

        // Load configuration files and proyect map
        ...
        // Root path to the view directory
        $this->path_view = $_SERVER['DOCUMENT_ROOT'] . $urlApp . '/view' . $viewPath . '/';

        // Relative URL to the views directory
